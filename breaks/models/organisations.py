...
class Organisation(models.Model):
    ...
    director = models.ForeignKey(User, models.RESTRICT, related_name='organisation_directors', verbose_name='Директор')
    employees = models.ManyToManyField(User, related_name='organisations_employees',
...
class Group(models.Model):
    organisation = models.ForeignKey('breaks.Organisation', models.CASCADE, related_name='groups',
                                      verbose_name='Организация')
    name = models.CharField('Название', max_length=150)
